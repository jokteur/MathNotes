...
namespace RichText {
    ...
    ABConfig::ABConfig() {
        ...
        // Display latex
        styles[B_LATEX].set_h_margins(EmVec2(emfloat{ 15.f }, emfloat{ 0.f }));
        styles[B_LATEX].set_v_margins(EmVec2(emfloat{ 0.f }, emfloat{ 0.f }));
        ...
        styles[LI].set_v_margins(EmVec2(emfloat{ 10.f }, emfloat{ 0.f }));
